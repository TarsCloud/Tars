...
Nowadays it's used by hundreds of business in Tencent, services that developed base on TAF run on 16 thousands of machines.
...
If you are familiar to Tars, refer to scripts in directory [build](build), may some modification needed.

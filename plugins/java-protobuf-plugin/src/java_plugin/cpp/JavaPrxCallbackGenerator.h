#ifndef _NET_TARS_PRX_CALLBACK_COMPILER_JAVA_GENERATOR_H_
#define _NET_TARS_PRX_CALLBACK_COMPILER_JAVA_GENERATOR_H_
...
#endif  // _NET_TARS_PRX_CALLBACK_COMPILER_JAVA_GENERATOR_H_
